...
class MathematicalRenderingTest : public MouCaGameEngine3DTest
{
public:
    void updateUBO(MouCa3DEngine::Engine3DXMLLoader& loader, const Vulkan::ContextDevice& context, float time)
    {
