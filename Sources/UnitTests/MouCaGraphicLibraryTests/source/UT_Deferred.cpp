...
class DeferredTest : public MouCaGameEngine3DTest
{
    public:
        ...
        void makeScene()
        {
            ...
            const auto& meshPath    = resources.getResourceFolder(MouCaCore::IResourceManager::Meshes);
