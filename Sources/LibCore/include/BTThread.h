    ...
    class Thread
    {
        ...
        public:
            ...
            virtual ~Thread()
            {
                ...
                BT_PRE_CONDITION(isNull() || isTerminated());
            }
            ...
            void start()
            {
                BT_PRE_CONDITION(isNull());  //DEV Issue: Second start() calling !
            ...
            {
                BT_PRE_CONDITION(!isNull());    //DEV Issue: Need start() before
