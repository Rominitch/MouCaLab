...
{   
    ...
    float f = dot( fbm2( 1.0*(0.05*ubo.fTime + p + fbm2(-0.05*ubo.fTime+2.0*(p + fbm2(4.0*p)))) ), vec2(1.0,-1.0) );
...
void main()
{
    vec2 p = (-iResolution.xy+2.0*inUV.xy)/iResolution.y;
