...
try:
    ...
    print("Impossible to import gdd packages.")
    raise
...
class GoogleDriveDownloader:
    ...
    @staticmethod
    def download(file_id, dest_path, overwrite=False, unzip=False, showsize=False):
        """
        ...
        if not exists(dest_path) or overwrite:
            ...
            if not response.ok:
                raise RuntimeError("Impossible to download data from id=" + str(file_id))
